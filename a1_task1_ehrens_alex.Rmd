...
count_plot1 <- ggplot(data = amphibians_ramu_count,
  ...
  labs(title = "Counts of mountain yellow-legged frogs (Rana muscosa) by year and life stage",
       subtitle = "1995 - 2002",
       fill = "Life Stage",
       color = "Life Stage",
       x = "Year of Survey",
...
count_plot2 <- ggplot(data = amphibians_top5_lakes,
  ...
  theme_minimal() +
  labs(title = "Top 5 lakes with the highest observed counts of adult and subadult mountain \nyellow-legged frogs (Rana muscosa)",
...
```{r}
patchwork_plot <- count_plot1 / count_plot2 & labs(caption = "ADD CAPTION LATER")
